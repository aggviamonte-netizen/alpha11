...
export const CREATURES: Creature[] = [
  ...
  { tier: 3, code: 'A3', name: 'Zanahoria', emoji: '🥕', color: 0xff8a2a, hex: '#FF8A2A', unitR: 0.74, kind: 'poly', aspectW: 0.78, aspectH: 1.22 },
  { tier: 4, code: 'A4', name: 'Pimiento', emoji: '🫑', color: 0xff3b5c, hex: '#FF3B5C', unitR: 0.88, kind: 'poly', aspectW: 0.95, aspectH: 1.12 },
  { tier: 5, code: 'A5', name: 'Berenjena', emoji: '🍆', color: 0x7b4dff, hex: '#7B4DFF', unitR: 1.04, kind: 'capsule', aspectW: 0.72, aspectH: 1.28 },
  { tier: 6, code: 'A6', name: 'Brócoli', emoji: '🥦', color: 0x3ddb6a, hex: '#3DDB6A', unitR: 1.22, kind: 'poly', aspectW: 1.08, aspectH: 1.12 },
  { tier: 7, code: 'A7', name: 'Mazorca', emoji: '🌽', color: 0xf5d547, hex: '#F5D547', unitR: 1.42, kind: 'capsule', aspectW: 0.7, aspectH: 1.32 },
